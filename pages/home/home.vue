<template>
	<view>
		...
		<view class="home-adv u-f-ajc animated fadeIn fast" >
			<image src="https://qushi3.oss-cn-beijing.aliyuncs.com/static/demo/demo20.jpg" mode="widthFix" lazy-load></image>
		</view>
		<!-- 功能列表 -->
	...
	export default {
		...
		data() {
			return {
				islogin:true,
				homeinfo:{
					userpic:"https://qushi3.oss-cn-beijing.aliyuncs.com/static/demo/userpic/11.jpg",
					username:"昵称",
					totalnum:0,
					todaynum:0,
				},
				...
				list:[
					...
					{ icon:"huiyuanvip",name:"趣事认证",clicktype:"",url:"" },
					{ icon:"keyboard",name:"审核趣事",clicktype:"",url:"" },
				]
			};
		},
