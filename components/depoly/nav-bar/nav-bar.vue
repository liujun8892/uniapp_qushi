<template>
	<view>
		...
		<!-- <view class="example-body"> -->
			<uni-nav-bar :statusBar="true" left-icon="arrowleft"  right-text="发布"  @clickLeft="back" >
				<block slot="left">
					<view class="city flex_center">
		...
		<view class="example-body">
			<uni-nav-bar left-icon="arrowleft" left-text="返回" title="标题" @clickLeft="back" />
		</view>
